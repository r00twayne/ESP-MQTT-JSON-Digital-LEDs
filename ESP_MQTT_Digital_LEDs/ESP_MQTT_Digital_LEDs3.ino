...
const char* ssid = "PRISIM-2.4"; //type your WIFI information inside the quotes
const char* password = "48291019";
const char* mqtt_server = "192.168.86.46";
const char* mqtt_username = "hassio";
const char* mqtt_password = "hassio";
